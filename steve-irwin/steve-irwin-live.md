...
---
## Garden — Context
- Victorian semi-detached terrace in Shoreham-by-Sea, West Sussex
- Garden: 15m long x 5.5m wide, WSW-facing
- Layout: 4m sandstone patio (near house) → 6m lawn → patio + raised beds at rear
- Soil: sandy loam — drains quickly, dries fast in warm/breezy conditions
- Topsoil used: Eurogreen 50/50 topsoil and compost mix on beds
---
## Garden — Plants & Shrubs
### Rosemary
- Chose **'Roman Beauty'** (Salvia rosmarinus 'Roman Beauty') — compact mounding habit, violet-blue flowers, extended flowering season, very tidy
- Planted mid-garden where it gets best all-day sun
- Care: full sun, well-drained soil (add grit if needed), drought-tolerant once established, light prune after flowering
- Pairs well with lavender, sage, drought-tolerant grasses for Mediterranean effect
- Purchased July 2025 — confirmed purchase
### Smoke Bush (Cotinus)
- Planted summer 2025 (approx. 2 months before Oct 2025 check-in)
- Grew well from 0.5m; turned very red and shed leaves in autumn — confirmed as **normal deciduous behaviour**
- Will go bald until spring — expected to return with new foliage
- Care: water during dry spells in year 1, add mulch to protect roots, avoid waterlogging
### Peony
- Moved to the garden; growing in Eurogreen 50/50 topsoil
- Needs full sun (min 6hrs), WSW facing is adequate if not shaded by other plants
- Prefers not to be disturbed once settled after being moved
### Jasmine
...
- Decision: leave to bloom so visiting family member can enjoy them in final 4 days of visit (early March 2026)
- Pre-flower mowing ruled out — cutting leaves at this stage only delays flowering ~1 week, does not kill bulbs; bulbs underground are already primed
- **Lawn plan:** Let foliage die back naturally 6–8 weeks post-flowering (approx. June); then begin regular robot mowing to starve bulbs over 2–3 seasons
- **Flower bed plan:** After flowering, dig out bulbs with hand fork to 15–20cm depth; sieve soil for offsets; check again in autumn
- Do NOT compost — brown bin or black bin only (invasive non-native species UK)
- Expect 2–3 seasons of consistent effort to significantly reduce population
---
## Garden — Lawn
- Turf laid **mid-July 2025** on sandy loam
- Lawn area approx. **6m x 5.5m** with patios either side and path down one side
### New Turf Care (key learnings)
- Water twice daily (morning + evening) for first week; deep soak to 10cm — critical on sandy loam
- Keep off for 2–3 weeks minimum
- First mow after ~3 weeks at high blade setting
- Top-dress joints with sand/soil mix immediately after laying
- Fertilise lightly after 4–6 weeks
### Sprinkler
- Chose **oscillating sprinkler** (purchased on eBay)
- Reason: rectangular spray pattern suits 6m x 5.5m lawn; avoids overspray onto patios and path
- Impact sprinklers ruled out — circular pattern harder to control
...
- Decision factors: storage space concern, dislike of petrol/corded models
- Other models considered: Husqvarna Aspire R4, Flymo EasiLife Go, Worx Landroid S300, LawnMaster L10
- Second-hand sources researched: eBay, Gumtree, Facebook Marketplace; local suppliers Platts Robotics, Hugh Page, Horace Fuller (Sussex)
- Winter care: store indoors to protect battery
### Storage
- **Keter City 113L Outdoor Storage Box** (grey) identified as best fit under windowsill (max 90cm H)
  - External dims: 57.8cm W x 44cm D x 54.8cm H
  - 96% recycled material, weatherproof, zero maintenance
  - Robot mower (with handles folded) expected to fit
- Alternatives considered: VonHaus 270L (114cm L x 51cm W x 56cm H), B&Q/Homebase resin boxes
- Confirmed Bosch mower was purchased
---
## Garden — Soil & Materials
### Treated Timber in Flower Beds
- UC4 pressure-treated timber under flower beds is safe for ornamentals — copper leaching is minimal and binds to soil
- Expected lifespan in-ground: 10–15 years (quality UC4)
- Avoid old CCA-treated timber (pre-2004, contains arsenic)
- Tips: use Postsaver sleeve or sheet plastic barrier at soil line; consider oak or cedar for longevity without chemicals
### Hardcore/Rubble for Beds
- Hove Recycling Centre (Old Shoreham Road): disposal only — no scheme to collect or buy rubble
- Monthly limit: 6 small bags (~25kg each) per household at Hove
- For sourcing hardcore: use Freecycle/Gumtree, local social media, leftover building materials from neighbours
- Shoreham Recycling Centre (West Sussex County Council) is a separate, closer option
### Topsoil
- Using Eurogreen 50/50 topsoil + compost mix
- Researched how much 10cm application settles on turned earth in raised beds
---
## Garden — Furniture & Accessories
### Garden Furniture
- Researched Habitat x Scion folding wooden chairs — suitability for leaving outside year-round in Shoreham checked
- Compared **acacia** (Laura James) vs **eucalyptus** (Deuba/XXI) for outdoor furniture durability in Shoreham coastal conditions
...
- **Hove Recycling Centre** — disposal only, not a source for materials
...
**Retailer:** My Secure Garden ([mysecuregarden.co.uk](http://mysecuregarden.co.uk/))
**Pricing at time of order:**
- Unit (sale): £639.75 (was £699.00)
- Trimetals Protective Wooden Subfloor: £90.00
- Cart subtotal: £729.75
- Ramp not yet added — recommended to add before checkout (~£45–50)
**Key dimensions:**
- External: 196cm (W) × 89cm (D) × 133cm (H)
- Internal: 180cm (W) × 84cm (D) × 109cm (front H) / 129cm (back H)
- Sloping lid, spring-assisted concertina up-and-over opening
**Why this unit:**
- Low profile (133cm) — hidden behind 2.4m front hedge
- Folded Duet V3 (89cm tall) fits with ~20cm clearance
- Future-proof for 2–3 bikes + kids' scooters/trikes
- UK-made PVC-coated galvanised steel, zero maintenance, 25-year guarantee
- RHS endorsed
- Anthracite suits Victorian terrace brick frontage
**Planning note:** Front garden placement requires planning permission (Adur District Council). Hedge screening strengthens application. Height (133cm) well under 2.5m threshold — low-risk application.
**Price watch:** Subfloor at £90 may be cheaper via Shedstore/Trimetals direct (~£35–45). Check before completing order.
---
## Bedding & Mattresses
### Master Bedroom Mattress
- **Mattress:** Latex Sense Sensation Hybrid King — purchased Feb 2022 (approx. 4 years old)
- **Cover:** Tencel outer cover, zip-access, never machine washed
- **Weight:** 56kg — manoeuvring to remove/refit cover is a significant task
- **Stain treatment (Apr 2026):** Protein stain (palm-sized, went through sheet to cover) treated in-situ with diluted white wine vinegar (50/50 water), dabbed with e-cloth, dried with dehumidifier — effective; most staining removed
- **Cover wash status:** Not yet machine washed in its lifetime; consider 30°C gentle cycle wash at next opportunity
- **Key principle:** Keep moisture surface-level only — latex beneath must not get wet
- **Recommended protector:** Woolroom Deluxe Washable Wool Mattress Protector (King) — ~£85–120; breathable, waterproof, suits latex
### Children's Mattresses
- **Mattresses:** Little Green Sheep Wool Coconut Core and Latex sleeping pads (both twins)
- **Protection:** Bamboo waterproof mattress protectors already fitted on both — adequate for bed-wetting stage
- **No further protectors needed at this time**
### Mattress Cleaning Protocol (for reference)
- Protein stains (urine, semen): cold water + biological washing powder enzyme solution — dab, never rub, work inward from edges
- Odour neutraliser: diluted white wine vinegar (50/50) — spray and dab
